...
int getDay(string d)
{
   // Function body
    istringstream my_stream(d);
    string token;
    getline(my_stream, token, '/'); // skip month
    getline(my_stream, token, '/'); // get day
    return stoi(token);
}
...
int getYear(string d) 
{
    ...
    string token;
    getline(my_stream, token, '/'); // skip month
    getline(my_stream, token, '/'); // skip day
    getline(my_stream, token, '/'); // get year
    return stoi(token);
}
/* This function takes as argument a string representing a date
...
int getHour(string d) 
{
    ...
    getline(my_stream, token, '/'); // skip month
    getline(my_stream, token, '/'); // skip day
    getline(my_stream, token, '/'); // skip year
    getline(my_stream, token, '/'); // get hour
    return stoi(token);
}